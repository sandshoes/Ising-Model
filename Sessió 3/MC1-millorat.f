      ...
      integer*4 SEED, i,j, L, mctot,ene, N
      parameter (L = 20)
      integer*4 PBC(0:L+1), MCINI
      integer*4 imc, ipas, suma
      integer*2 S(1:L,1:L)
      real*8 genrand_real2,MAG,MAGNE,TEMP,DE
      real*8 DELTA, energ
      character*25 nom
      
      open(UNIT=12, FILE="t4500.dat")
      MCINI = 1000
      SEED=23457
      mctot = 10000
      TEMP = 4.5D0
      ...
      ENE = ENERG(S,L,PBC)
c  New program from here onwards      
      do imc = 1, mctot
        do ipas = 1, N
          i = genrand_real2()*L +1
          j = genrand_real2()*L +1 
