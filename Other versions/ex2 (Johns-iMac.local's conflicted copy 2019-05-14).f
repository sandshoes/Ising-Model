...
C     ------------------------------------------------------
      ...
      REAL*8 SUM,SUME,SUME2,SUMM,SUMM2,SUMAM,VARE,VARM, DTEMP
      REAL*4 TIME1, TIME2
      CHARACTER*3 NOM
...
C          CALL WRITECONFIG(S,L)
     ...
     +               +S(PBC(I+1),J)+S(PBC(I-1),J)
        ...
        WRITE(12,*) IMC,TEMP,SUM,SUME/N,SUME2/N**2,VARE,SUMM/N,SUMAM/N,
     +              SUMM2/N**2,VARM
...
C     ---------------------------------------
      ...
      DO I=1,L
        DO J = 1,L
          ENE = ENE-S(I,J)*S(PBC(I+1),J)-S(I,J)*S(I,PBC(I+1))
        ENDDO
      ENDDO
      ENERG = ENE
      RETURN
